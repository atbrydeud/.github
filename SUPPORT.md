...
Ask in the repository that owns the concern. This repository is the front door,
...
| Protocol spec, contract, SDK, token/governance mechanics or compatibility | [`ecosystem-protocols`](https://github.com/atbrydeud/ecosystem-protocols/issues) |
| Organization profile, shared template or architecture map | [`.github`](https://github.com/atbrydeud/.github/issues) |

Use [docs/PROJECT_MAP.md](docs/PROJECT_MAP.md) for detailed examples. Report
security vulnerabilities through [SECURITY.md](SECURITY.md), never a public issue.

...
**An AI-first ecosystem for creating, equipping and operating independent
...
The Web3 product/protocol domain is separate from that organizational stack:
...
- Git is the canonical source for definitions and review history.
- Secrets never live in Git; Bootstrap records safe references and connections.
- Identities, state, secrets, infrastructure, data and production authority are
  separated by organization.
- Downstream organizations remain operational if central At Bryde Ud services
  are unavailable.
- Reusable baselines are versioned and drift is detectable.
- Humans retain consequential authority; agents act within explicit boundaries.

## Start here

- [Ecosystem architecture](https://github.com/atbrydeud/.github/blob/main/docs/ECOSYSTEM.md)
- [“Where does this change belong?” project map](https://github.com/atbrydeud/.github/blob/main/docs/PROJECT_MAP.md)
- [Architecture principles](https://github.com/atbrydeud/.github/blob/main/docs/ARCHITECTURE_PRINCIPLES.md)
- [Getting started](https://github.com/atbrydeud/.github/blob/main/docs/GETTING_STARTED.md)
- [Contributing](https://github.com/atbrydeud/.github/blob/main/CONTRIBUTING.md) ·
  [Governance](https://github.com/atbrydeud/.github/blob/main/GOVERNANCE.md) ·
  [Security](https://github.com/atbrydeud/.github/blob/main/SECURITY.md)
